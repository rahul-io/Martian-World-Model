...
import sys
sys.path.append('/mnt/workspace/yyy/yyy/ac3d')
sys.path.append('/mnt/workspace/yyy/yyy/ac3d/training')
...
def generate_video(
    ...
    for camera_idx in range(0,len(eval_dataset)):
        ...
        print('controlnet_latents:', controlnet_latents.shape)  #([1, 49, 6, 480, 720])
        print('reference_video:', reference_video.shape)  #([49, 3, 480, 720])
        ...
        video_generate_all = pipe(
            #latents=torch.load('/mnt/workspace/yyy/yyy/ac3d/inference/latents.pt')[:,0:13],
            prompt=prompt,
            image=images,
        ...
        if save_ref:
            ...
            print('output_path_file_reference:', output_path_file_reference)    
