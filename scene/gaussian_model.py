...
from component.lib_bilagrid import BilateralGrid, color_correct, slice, total_variation_loss
import math
...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int, use_bilateral_grid : bool = False, bilateral_grid_shape : tuple = (16,16,8)):
        ...
        self.bilateral_grid_shape = bilateral_grid_shape
    ...
    def training_setup(self, training_args):
        ...
        if self.use_bilateral_grid:
            ...
            self.bil_grid_schedulers = torch.optim.lr_scheduler.ChainedScheduler(
                        [
                            ...
                            torch.optim.lr_scheduler.ExponentialLR(
                                self.bil_grid_optimizers[0], gamma=0.01 ** (1.0 / training_args.iterations)
                            ),
                        ]
                    )
