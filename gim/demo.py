...
from gim.tools import get_padding_size
from gim.networks.roma.roma import RoMa
from gim.networks.loftr.loftr import LoFTR
from gim.networks.loftr.misc import lower_config
from gim.networks.loftr.config import get_cfg_defaults
from gim.networks.dkm.models.model_zoo.DKMv3 import DKMv3
from gim.networks.lightglue.superpoint import SuperPoint
from gim.networks.lightglue.models.matchers.lightglue import LightGlue
...
def gim_run(img0=None, img1=None, model_type="gim_roma"):
    ...
    # weights path
    checkpoints_path = join('./gim/weights', ckpt)
    ...
    if model_type == 'gim_dkm' or model_type == 'gim_roma':
        if model_type == 'gim_dkm':
        ...
        gray0 = preprocess(image0, grayscale=True)[0]
        gray1 = preprocess(image1, grayscale=True)[0]
    ...
    return kpts0.cpu().numpy(), kpts1.cpu().numpy(), mask
